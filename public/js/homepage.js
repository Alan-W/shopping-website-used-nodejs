	...
	$.ajax({
            ...
            success : function(data) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    str += '<div class="single-project"><a href="dianpu?'+row._id+'"><img src="'+ row.logo+'"/></a><div class="pro-title clearfix"><a href="">' + row.remarkName + '</a><strong>' +row.province+ '</strong><p>' +'better perching'+ '</p></div><p class="financed"><em>已筹资</em>'+'Y 1225000.00'+'</p><div class="progress"><span><b>'+'98%'+'</b></span></div><div class="financing-ask clearfix"><div class="total"><p>Y125万</p><p>众筹融资总额</p></div><div class="perbuy"><p>Y2.5万</p><p>单投资人最低出额</p></div></div><div class="exchange"><em>关注：'+'173'+'</em><em>约谈：'+'21'+'</em><em>认购：'+'29'+'</em></div></div>';
                }
